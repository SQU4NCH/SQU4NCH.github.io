---
date: 2023-08-10 23:48:05
layout: post
title: Remote Code Execution via Polyglot Web Shell Upload
subtitle: 
description: >-
  Write Up do lab 'Remote Code Execution via Polyglot Web Shell Upload' da PortSwigger.
image: >-
  /assets/img/RCE-via-polyglot-file/00.jpg
optimized_image: >-
  /assets/img/RCE-via-polyglot-file/00.jpg
category: Write Up
tags:
...
![](/assets/img/RCE-via-polyglot-file/01.png){: .align-center}
...
![](/assets/img/RCE-via-polyglot-file/02.png){: .align-center}
...
![](/assets/img/RCE-via-polyglot-file/03.png){: .align-center}
...
![](/assets/img/RCE-via-polyglot-file/04.png){: .align-center}
...
![](/assets/img/RCE-via-polyglot-file/05.png){: .align-center}
...
![](/assets/img/RCE-via-polyglot-file/06.png){: .align-center}
...
![](/assets/img/RCE-via-polyglot-file/07.png){: .align-center}

Voltando a conta do usuário, é possível ver que a imagem foi carregada

![](/assets/img/RCE-via-polyglot-file/08.png){: .align-center}

Agora, basta abrir a imagem em uma nova aba para ver o seu conteúdo

![](/assets/img/RCE-via-polyglot-file/09.png){: .align-center}
...
![](/assets/img/RCE-via-polyglot-file/10.png){: .align-center}