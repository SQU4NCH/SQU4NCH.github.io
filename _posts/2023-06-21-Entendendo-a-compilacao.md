---
date: 2023-06-21 23:48:05
layout: post
title: Entendendo o processo de compilação de um programa em C
subtitle: 
description: >-
  Breve artigo explicando como funciona o processo de compilação de um programa em C.
image: >-
  /assets/img/Entendendo-compilacao/00.jpg
optimized_image: >-
  /assets/img/Entendendo-compilacao/00.jpg
...
![](/assets/img/Entendendo-compilacao/01.png){: .align-center}
...
![](/assets/img/Entendendo-compilacao/02.png){: .align-center}
...
![](/assets/img/Entendendo-compilacao/03.png){: .align-center}
...
![](/assets/img/Entendendo-compilacao/04.png){: .align-center}
...
![](/assets/img/Entendendo-compilacao/05.png){: .align-center}
...
![](/assets/img/Entendendo-compilacao/06.png){: .align-center}
