---
date: 2023-10-24 23:48:05
layout: post
title: Interceptando tráfego no Android
subtitle: 
description: >-
  Breve tutorial sobre a configuração do Android para interceptação de tráfego web através do Burp.
image: >-
  /assets/img/burp-Android/00.jpg
optimized_image: >-
  /assets/img/burp-Android/00.jpg
category: Mobile
tags:
...
![](/assets/img/burp-Android/M-01.png){: .align-center}
...
![](/assets/img/burp-Android/M-02.png){: .align-center}

Após isso é só confirmar o desligamento dos dados móveis.

![](/assets/img/burp-Android/M-03.png){: .align-center}
...
![](/assets/img/burp-Android/M-09.png){: .align-center}
...
![](/assets/img/burp-Android/M-10.png){: .align-center}
...
![](/assets/img/burp-Android/M-11.png){: .align-center}

Depois em "Security & location".

![](/assets/img/burp-Android/M-12.png){: .align-center}

Depois em "Encryption & credentials".

![](/assets/img/burp-Android/M-13.png){: .align-center}

E por fim em "Install from SD card".

![](/assets/img/burp-Android/M-14.png){: .align-center}

Ao abrir essa opção, vá no menu presente no canto superior esquerdo e em seguida abra a pasta de Downloads.

![](/assets/img/burp-Android/M-15.png){: .align-center}
![](/assets/img/burp-Android/M-16.png){: .align-center}

Pronto, ai está o certificado.

![](/assets/img/burp-Android/M-17.png){: .align-center}

Agora basta clicar no arquivo, escolher o nome do certificado e realizar a instalação.

![](/assets/img/burp-Android/M-18.png){: .align-center}
...
![](/assets/img/burp-Android/M-19.png){: .align-center}